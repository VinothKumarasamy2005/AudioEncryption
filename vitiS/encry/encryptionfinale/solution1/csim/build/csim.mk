...
HLS_SOURCES = ../../../tb.cpp ../../../chaotic_encrypt.cpp
...
$(ObjDir)/chaotic_encrypt.o: ../../../chaotic_encrypt.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling ../../../chaotic_encrypt.cpp in $(BuildMode) mode" $(AVE_DIR_DLOG)
	$(Verb)  $(CC) ${CCFLAG} -c -MMD  $(IFLAG) $(DFLAG) $< -o $@ ; \

-include $(ObjDir)/chaotic_encrypt.d
