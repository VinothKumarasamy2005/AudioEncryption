set moduleName encryfinal_Pipeline_VITIS_LOOP_46_3
set isTopModule 0
...
set C_modelName {encryfinal_Pipeline_VITIS_LOOP_46_3}
set C_modelType { void 0 }
set C_modelArgList {
	{ step_2 int 25 regular  }
	{ transformedSignal double 64 regular {array 16 { 1 1 } 1 1 }  }
	{ temp double 64 regular {array 16 { 0 3 } 0 1 }  }
	{ trunc_ln int 4 regular  }
}
set hasAXIMCache 0
set AXIMCacheInstList { }
set C_modelArgMapList {[ 
	{ "Name" : "step_2", "interface" : "wire", "bitwidth" : 25, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ step_2 sc_in sc_lv 25 signal 0 } 
	{ transformedSignal_address0 sc_out sc_lv 4 signal 1 } 
	{ transformedSignal_ce0 sc_out sc_logic 1 signal 1 } 
	{ transformedSignal_q0 sc_in sc_lv 64 signal 1 } 
	{ transformedSignal_address1 sc_out sc_lv 4 signal 1 } 
	{ transformedSignal_ce1 sc_out sc_logic 1 signal 1 } 
	{ transformedSignal_q1 sc_in sc_lv 64 signal 1 } 
	{ temp_address0 sc_out sc_lv 4 signal 2 } 
	{ temp_ce0 sc_out sc_logic 1 signal 2 } 
	{ temp_we0 sc_out sc_logic 1 signal 2 } 
	{ temp_d0 sc_out sc_lv 64 signal 2 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "step_2", "direction": "in", "datatype": "sc_lv", "bitwidth":25, "type": "signal", "bundle":{"name": "step_2", "role": "default" }} , 
 	...
 	{ "name": "transformedSignal_address1", "direction": "out", "datatype": "sc_lv", "bitwidth":4, "type": "signal", "bundle":{"name": "transformedSignal", "role": "address1" }} , 
 	{ "name": "transformedSignal_ce1", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "transformedSignal", "role": "ce1" }} , 
 	{ "name": "transformedSignal_q1", "direction": "in", "datatype": "sc_lv", "bitwidth":64, "type": "signal", "bundle":{"name": "transformedSignal", "role": "q1" }} , 
...
set RtlHierarchyInfo {[
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.dadddsub_64ns_64ns_64_8_full_dsp_1_U6", "Parent" : "0"},
	{"ID" : "2", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.ddiv_64ns_64ns_64_59_no_dsp_1_U7", "Parent" : "0"},
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "72", "Max" : "536870980"}
	, {"Name" : "Interval", "Min" : "72", "Max" : "536870980"}
]}
...
set Spec2ImplPortList { 
	step_2 { ap_none {  { step_2 in_data 0 25 } } }
	transformedSignal { ap_memory {  { transformedSignal_address0 mem_address 1 4 }  { transformedSignal_ce0 mem_ce 1 1 }  { transformedSignal_q0 mem_dout 0 64 }  { transformedSignal_address1 MemPortADDR2 1 4 }  { transformedSignal_ce1 MemPortCE2 1 1 }  { transformedSignal_q1 MemPortDOUT2 0 64 } } }
