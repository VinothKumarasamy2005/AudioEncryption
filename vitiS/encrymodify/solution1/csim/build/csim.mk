...
HLS_SOURCES = ../../../test.cpp ../../../encryfinal.cpp
...
$(ObjDir)/encryfinal.o: ../../../encryfinal.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling ../../../encryfinal.cpp in $(BuildMode) mode" $(AVE_DIR_DLOG)
	$(Verb)  $(CC) ${CCFLAG} -c -MMD  $(IFLAG) $(DFLAG) $< -o $@ ; \

-include $(ObjDir)/encryfinal.d
