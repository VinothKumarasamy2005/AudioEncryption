...
set Library     "hls"
set IPName      "encryfinal"
set Version     "1.0"
set DisplayName "Encryfinal"
set Revision    "2113953647"
...
set xo_kernel_name "encryfinal"
set xo_kernel_files {}
set enable_xo_gen false
set kernel_xml [file join [pwd] ../kernel/kernel.xml]
set solution_dir "C:/Windows/vitiS/encrymodify/solution1"
set solution_json_file [file join $solution_dir [file tail $solution_dir]_data.json]
set debug_dir "C:/Windows/vitiS/encrymodify/solution1/.debug"
set xo_hls_files_dir ""
set hdl_module_list {encryfinal_sitodp_32ns_64_6_no_dsp_1
...
set kernel_xo ""
set detect_deadlock_json "encryfinal_message_dict.json"

## Variables
set Top "encryfinal"
set TopNoPrefix "encryfinal"
...
set Interfaces {
    s_axi_control {
        ...
        memories "speechSignal {base_address 64 range 64} encryptedSignal {base_address 128 range 128}"
        ctype {
            AWVALID {
                Type "bool"
                Width "1"
...
## System Info
set user_parameters_list {clk_period 10 machine 64 combinational 0 latency 474 II x}
