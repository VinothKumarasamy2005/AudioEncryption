...
HLS_SOURCES = ../../../tb.cpp ../../../framing.cpp
...
$(ObjDir)/framing.o: ../../../framing.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling ../../../framing.cpp in $(BuildMode) mode" $(AVE_DIR_DLOG)
	$(Verb)  $(CC) ${CCFLAG} -c -MMD  $(IFLAG) $(DFLAG) $< -o $@ ; \

-include $(ObjDir)/framing.d
