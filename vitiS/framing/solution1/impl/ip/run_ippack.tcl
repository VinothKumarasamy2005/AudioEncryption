...
set IPName      "framing"
set Version     "1.0"
set DisplayName "Framing"
set Revision    "2113950697"
...
set xo_kernel_name "framing"
set xo_kernel_files {}
set enable_xo_gen false
set kernel_xml [file join [pwd] ../kernel/kernel.xml]
set solution_dir "C:/Windows/vitiS/framing/solution1"
set solution_json_file [file join $solution_dir [file tail $solution_dir]_data.json]
set debug_dir "C:/Windows/vitiS/framing/solution1/.debug"
set xo_hls_files_dir ""
set hdl_module_list {framing_control_s_axi
framing_regslice_both
framing_regslice_both
framing
}
set kernel_xo ""
set detect_deadlock_json "framing_message_dict.json"

## Variables
set Top "framing"
set TopNoPrefix "framing"
...
set Interfaces {
    ...
    ap_clk {
        ...
        buses "s_axi_control input_signal output_frames"
        reset "ap_rst_n"
    }
    ap_rst_n {
        type "reset"
