...
__attribute__((sdx_kernel("chensy", 0))) void chensy(
    float dt,
    int num_iterations,
...
#line 16 "C:/Windows/vitiS/rinos/solution1/csynth.tcl"
#pragma HLSDIRECTIVE TOP name=chensy
# 8 "rinos/chen.cpp"


    float x = 0.0, y = 0.01, z = 0.01, w = 0.0;

    VITIS_LOOP_12_1: for (int i = 0; i < num_iterations; i++) {
